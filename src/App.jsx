...
export default function App() {
  ...
  useEffect(() => { if (token) loadCreations(); }, [token]);
...
.tayf-root h1,.tayf-root h2,.tayf-root h3{font-family:'Cairo','Noto Sans','Noto Sans Devanagari',sans-serif;margin:0;font-weight:800}
...
.hero h1{font-size:clamp(40px,7vw,82px);font-weight:800;line-height:1.1;letter-spacing:-1px}
