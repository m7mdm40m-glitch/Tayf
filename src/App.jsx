...
const F_CONTACT = { ar:"تواصل معنا", en:"Contact", ku:"پەیوەندیمان پێوە بکە", fa:"تماس با ما", ur:"رابطہ کریں" };
            ...
            {adminLoading ? (
              ...
              <>
                ...
                <div className="admin-toolbar">
                  <span className="admin-count">{adminUsers.length} مستخدم</span>
...
.mw-media{position:relative;aspect-ratio:1/1;background:var(--surface);cursor:zoom-in;overflow:hidden}
